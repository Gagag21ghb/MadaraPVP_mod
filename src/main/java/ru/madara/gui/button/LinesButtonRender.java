...
public class LinesButtonRender extends Widget implements Wrapper {
    public LinesButtonRender(int p_i232254_1_, int p_i232254_2_, int p_i232254_3_, int p_i232254_4_, ITextComponent p_i232254_5_) {
    ...
    public void renderButton(MatrixStack matrixStack, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
        StyledFontRenderer.drawShadowedCenteredYString(matrixStack, Madara.font, getMessage(), x + (double) width / 2 - (double) mc.font.width(getMessage()) / 2, y + (double) (height - 8) / 2, Color.WHITE);
